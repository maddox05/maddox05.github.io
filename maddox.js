  ...
  createBanner() {
    ...
    banner.innerHTML = `
            <div class="banner-content">
                <a href="${bannerData.link}?utm_source=maddoxschmidlkofer.com&utm_medium=banner&utm_campaign=maddoxschmidlkofer.com" class="banner-title" target="_blank" rel="noopener noreferrer">
                    ${bannerData.title}
                </a>
